            ...
            <h1 className="Title">LHS Mural Crew Gallery</h1>
                <Card className="card">
                    ...
                    <Card.Body>
                        ...
                        <Button variant="outline-light" href="/Murals/IntheGreatDeep">See mural details here</Button>
                    </Card.Body>
                </Card>
                <Card className="card">
                    ...
                    <Card.Body>
                        ...
                        <Button variant="outline-info" href="/Murals/TheCreationofScience">See mural details here</Button>
                    </Card.Body>
                </Card>
                <Card className="card">
                    ...
                    <Card.Body>
                        ...
                        <Button variant="outline-info" href="/Murals/AWalkinthePark">See mural details here</Button>
                    </Card.Body>
                </Card>
                <Card className="card">
                    ...
                    <Card.Body>
                        ...
                        <Button variant="outline-info" href="/Murals/LetTheBeautyOfWhatYouLoveBeWhatYouDo">See mural details here</Button>
                    </Card.Body>
                </Card>
            </div>
        )
