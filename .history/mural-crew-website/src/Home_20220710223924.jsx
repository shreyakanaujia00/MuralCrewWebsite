        ...
        return (
            ...
            <h1 className="Title">LHS Mural Crew Gallery</h1>
                <Card style={{ width: '18rem' }}>
                    <Card.Img className="card-img" variant="top" src={OctopusMural} />
                    <Card.Body>
                ...
                <Card style={{ width: '18rem' }}>
                    <Card.Img className="card-img" variant="top" src={HandMural} />
                    <Card.Body>
                        <Card.Title>Octopus Mural</Card.Title>
                        <Card.Text>
                        Octopus Mural
                ...
                <Card style={{ width: '18rem' }}>
                    <Card.Img className="card-img" variant="top" src={SpringMural} />
                    <Card.Body>
                        <Card.Title>Octopus Mural</Card.Title>
                        <Card.Text>
                        Octopus Mural
